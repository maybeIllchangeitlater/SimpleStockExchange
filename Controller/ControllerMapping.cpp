...
namespace s21{
    const std::unordered_map<std::string, ControllerMapping::UserFunction> ControllerMapping::method_mapping_user{
            ...
            {"DeleteUser", [](UserController& c, const nlohmann::json &json){ return c.DeleteUser(json); }},
            {"UpdateUserBalance", [](UserController& c, const nlohmann::json &json){ return c.UpdateUserBalance(json); }},
            {"UpdateUserName", [](UserController& c, const nlohmann::json &json){ return c.UpdateUserName(json); }},
            {"UpdateUserPassword", [](UserController& c, const nlohmann::json &json){ return c.UpdateUserPassword(json); }}
    };
    const std::unordered_map<std::string, ControllerMapping::BidFunction> ControllerMapping::method_mapping_bid{
            {"CreateBid", [](BidController& c, const nlohmann::json &json){ return c.CreateBid(json); }},
            {"GetBid", [](BidController& c, const nlohmann::json &json){ return c.GetBid(json); }},
            {"GetUserSellBids", [](BidController& c, const nlohmann::json &json){ return c.GetUserSellBids(json); }},
