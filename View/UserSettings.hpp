...
private:
    Ui::UserSettings *ui;
    std::unique_ptr<ChangeNamPopup> namechange_pop_ = boost::make_unique<ChangeNamPopup>();
    std::unique_ptr<ChangePassPopup> passchange_pop_ = boost::make_unique<ChangePassPopup>();
    std::unique_ptr<PasswordConfirmationPopup> confirm_pop_ = boost::make_unique<PasswordConfirmationPopup>();
};
