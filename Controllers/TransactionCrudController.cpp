#include "TransactionCrudController.hpp"

namespace s21{

    void TransactionCRUDController::CreateTransaction(const std::string &post_user_id, const std::string &rate,
    ...
    void TransactionCRUDController::ReadTransaction(const std::string &transaction_id) {
        pqxx::work task(db_connection_);
        try{
    ...
    void TransactionCRUDController::ReadAllUserSellTransactions(const std::string &user_id) {
        pqxx::work task(db_connection_);
        try{
    ...
    void TransactionCRUDController::ReadAllUserBuyTransactions(const std::string &user_id) {
        pqxx::work task(db_connection_);
        try{
    ...
    void TransactionCRUDController::DeleteTransaction(const std::string &transaction_id) {
        pqxx::work task(db_connection_);
        try{
    ...
    void TransactionCRUDController::UpdateTransactionRate(const std::string &transaction_id, const std::string &rate) {
        pqxx::work task(db_connection_);
        try{
    ...
    void TransactionCRUDController::UpdateTransactionQuantity(const std::string &transaction_id,
                                                              const std::string &quantity) {
        pqxx::work task(db_connection_);
        try{
    ...
    void TransactionCRUDController::UpdateTransactionBuyer(const std::string &transaction_id,
