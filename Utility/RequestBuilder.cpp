...
namespace s21 {
const std::unordered_map<RequestStringBuilder::RequestType,
                         std::pair<const char *, const char *>>
    RequestStringBuilder::request_method{
        ...
        {GET_USER_BUY_TRANSACTIONS,
         std::make_pair("GET", "TGetUserBuyTransactions")},
        {GET_USER_SELL_TRANSACTIONS,
         std::make_pair("GET", "TGetUserSellTransactions")},
        {GET_QUOTATIONS, std::make_pair("GET", "TGetQuotations")}};

std::string RequestStringBuilder::BuildRequest(
    s21::RequestStringBuilder::RequestType type, const nlohmann::json &body) {
