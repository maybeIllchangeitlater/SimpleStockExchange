...
struct ClientDisplayMessages {
  ...
  constexpr static const char* weekly_rate_for_usd =
      "This week rate for USD is:";
  constexpr static const char* monthly_rate_for_usd =
      "This month rate for USD is:";
  constexpr static const char* yearly_rate_for_usd =
      "This year rate for USD is:";
