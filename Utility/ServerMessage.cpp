...
namespace s21 {
const std::unordered_map<ServerMessage::MessageType, const char *>
    ServerMessage::server_message{
        {MessageType::WELCOME,
         "{Welcome to Stock Exchange. Please Register or Sign In to continue}"},
        {MessageType::NOT_LOGGED_IN,
         "{Operation requires you to be logged in}"},
        {MessageType::SERVER_FAILED_TO_START, "{Server failed to start}"},
        {MessageType::REGISTER_OK, "{User registration successful}"},
        {MessageType::REGISTER_BAD_NAME,
        ...
        {MessageType::REGISTER_BAD_PASSWORD,
         "{Password must be at least 6 symbols long and contain lower case, "
         "upper case and symbols/digits}"},
        {MessageType::BALANCE_BAD_BALANCE, "{Invalid balance}"},
        ...
        {MessageType::BID_BAD_QUANTITY,
         "{Quantity must be positive and non-zero}"},
        {MessageType::BID_NOT_YOURS, "{You can only delete your own bids}"},
        ...
        {MessageType::REQUEST_BAD_CONTENT_BODY,
         "{Missing body content where it must be present}"},
        {MessageType::REQUEST_BAD_CONTENT_TYPE,
...
const std::unordered_map<const char *, ServerMessage::ResponseCode>
    ServerMessage::response_code{
        ...
        {"{Password must be at least 6 symbols long and contain lower case, "
         "upper case and symbols/digits}",
         ResponseCode::BAD_REQUEST},
        {"{Invalid balance}", ResponseCode::BAD_REQUEST},
        ...
        {"{Bid not found}", ResponseCode::NOT_FOUND},
        ...
        {"{You can only delete your own bids}", ResponseCode::BAD_REQUEST},
...
const std::unordered_map<ServerMessage::ResponseCode, const char *>
    ServerMessage::status_message{{ServerMessage::OK, "OK"},
