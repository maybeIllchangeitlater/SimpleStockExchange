...
namespace s21 {
    ...
    public:
        ...
        virtual nlohmann::json CreateBid(const std::string &user_id, const std::string& rate,
                                         const std::string &quantity, BidType bid_type) = 0;
        virtual void CancelBid(const std::string &bid_id, const std::string &user_id) = 0;
        virtual nlohmann::json UpdateBidRate(const std::string &bid_id, const std::string &rate) = 0;
        virtual void UpdateBidQuantity(const std::string &bid_id, const std::string &quantity) = 0;
