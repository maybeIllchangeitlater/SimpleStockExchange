...
class BalanceServiceInterface {
 public:
  ...
  virtual void CreateUserBalance(const std::string &user_id,
  ...
  virtual void SetUserBalance(const std::string &user_id,
                              const std::string &user_balance_usd,
                              const std::string &user_balance_rub) = 0;
  virtual void IncreaseUsdDecreaseRubBalance(
      const std::string &user_id, const std::string &transaction_rate,
      const std::string &transaction_quantity) = 0;
  virtual void DecreaseUsdIncreaseRubBalance(
      const std::string &user_id, const std::string &transaction_rate,
      const std::string &transaction_quantity) = 0;
